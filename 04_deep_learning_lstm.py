...
This script implements a Long Short-Term Memory (LSTM) neural network for predicting
Remaining Useful Life (RUL) of aircraft engines. LSTM networks excel at learning
patterns in time-series data by maintaining memory of previous timesteps.

Model Architecture:
    - Input: 50-cycle sequences of sensor readings (50 timesteps x 17 features)
    - LSTM Layer 1: 128 units with sequence return
...
if val_rmse < best_ml_rmse:
    ...
    print(f"\n LSTM is {difference:.1f}% worse (this is normal - try tuning!)")
