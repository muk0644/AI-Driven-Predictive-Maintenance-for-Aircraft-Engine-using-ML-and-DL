...
This script implements a 1D Convolutional Neural Network for RUL prediction.
CNNs are effective at detecting local patterns in sensor data through convolutional
filters, and train faster than LSTM networks.

Model Architecture:
    - Input: 50-cycle sequences (50 timesteps x 17 features)
    - Conv1D Blocks: 3 blocks with 64, 128, 64 filters
    - Batch Normalization: After each convolutional layer
    - MaxPooling: Reduces dimensionality while keeping important features
    - Dense Layers: 64 and 32 units
    - Output: Single value (predicted RUL)

Why 1D CNN?
    - Detects local patterns in time-series sensor data
    - Faster training compared to LSTM
    - Good at identifying anomalies and degradation patterns
    - Uses sliding filters to extract features automatically
